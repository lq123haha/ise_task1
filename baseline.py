...
out_csv_name = f'./results/{project}_average_NB.csv'
...
# Each column is the result of each experiment for one indicator
detailed_results = {
    'Accuracy': accuracies,
...
results_df.to_csv(f'./results/{project}_NB_detailed_results.csv', index=False)
print(f"\nDetailed results have been saved to: ./results/{project}_NB_detailed_results.csv")
